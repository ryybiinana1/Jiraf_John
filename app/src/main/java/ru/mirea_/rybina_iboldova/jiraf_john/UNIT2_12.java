    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button2_unit1_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent = new Intent(UNIT2_12.this, UNIT2_13.class);
                startActivity(intent);}
                else {
                    Toast.makeText(UNIT2_12.this, "Need answer!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        View.OnClickListener answerButtonClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (answerText.equals(correctAnswer)) {
                    ...
                    Toast.makeText(UNIT2_12.this, "Right!", Toast.LENGTH_SHORT).show();
                } else {
