...
public class UNIT1_14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unit1_14);
        ...
        button2_unit1_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (IsAnswered) {
                    ...
                    intent = new Intent(UNIT1_14.this, UNIT1_22.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(UNIT1_14.this, "Need answer!", Toast.LENGTH_SHORT).show();
                }
        ...
        View.OnClickListener answerButtonClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (answerText.equals(correctAnswer)) {
                    ...
                    Toast.makeText(UNIT1_14.this, "Right!", Toast.LENGTH_SHORT).show();
                } else {
