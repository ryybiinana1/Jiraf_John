...
public class UNIT3_22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unit3_22);
        ...
        button2_unit1_22.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent = new Intent(UNIT3_22.this, UNIT3_23.class);
                startActivity(intent);}
                else {
                    Toast.makeText(UNIT3_22.this, "Need answer!", Toast.LENGTH_SHORT).show();
                }
            }
        });
