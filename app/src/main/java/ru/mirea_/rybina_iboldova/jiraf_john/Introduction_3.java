...
public class Introduction_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_introduction_3);
        ...
        Button_i.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent = new Intent(Introduction_3.this, UNIT3_11.class);
