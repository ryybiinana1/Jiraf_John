...
public class UNIT3_24 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unit3_24);
        ...
        button2_unit1_22.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);}
                    ...
                    Toast.makeText(UNIT3_24.this, "Need answer!", Toast.LENGTH_SHORT).show();
                }
            }
        });
